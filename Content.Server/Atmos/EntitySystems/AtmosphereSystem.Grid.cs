...
{
    [Robust.Shared.IoC.Dependency] private readonly ITileDefinitionManager _tileDefinitionManager = default!;
    [Robust.Shared.IoC.Dependency] private readonly GasTileOverlaySystem _gasTileOverlaySystem = default!;
